...
var template = [
  ...
  },
  {
    ...
    submenu: [
      ...
      },
      {
        label: 'Thing Setup',
        accelerator: 'Command+T',
        click: function() { mainWindow.loadURL('file://' + __dirname + '/content/setup.html'); }
      },
      {
        label: 'Reload',
  ...
  },
  {
    ...
    submenu: [
      ...
      {
        label: 'Debug',
        click: function() { mainWindow.loadURL('file://' + __dirname + '/content/debug.html'); }
      }
    ]
  },
  {
...
app.on('ready', function() {
  ...
  mainWindow = new BrowserWindow({width: 900 , height: 900, resizable: true});
